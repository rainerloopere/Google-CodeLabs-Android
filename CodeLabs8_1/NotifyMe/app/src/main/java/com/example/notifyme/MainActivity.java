...
//        Initializing notification button, call sendNotification when clicked
...
//        By using a PendingIntent to communicate with another app, you are telling that app to execute some predefined code at some point in the future. It's like the other app can perform an action on behalf of your app.
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this, PRIMARY_CHANNEL_ID)
                ...
                .setAutoCancel(true)
                .setPriority(NotificationCompat.PRIORITY_HIGH) //setting default priority for Android 7.1 or lower which don't use notification channel
...
//        Notification channels are available from API 26 and higher
